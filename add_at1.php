...
if(isset($_POST['btn-save']))
{
	...
	$sql_query = "INSERT INTO teacher(name,gender,contact,address,designation,department,username,password) VALUES('$name','$gender','$contact','$address','$designation','$department','$username','$password')";
	// sql query for inserting data into database
...
<div class="sidenav">
	...
	<div class="dropdown">
	  ...
	  <div class="dropdown-content" >
	  	<a style="font-size: 16px;" href="#">Add Attendance</a>
	  	<a style="font-size: 16px;" href="#">View Attendance</a>
	...
	<div id="main" style="margin-left: 180px;">
		...
		<form method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" id="Department" name="department" placeholder="Department" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input class="form-control" type="passowrd" id="Password" name="password" placeholder="Password" required />
			</div>
			<div class="form-group">
